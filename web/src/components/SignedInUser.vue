<template>
  ...
  >
    ...
    <div style="width:100%;max-width:640px;height: 200px;margin: 0 auto;font-family: monospace;"
         v-html="userDisplay"></div>
    <p>
      Id token
    </p>
    <p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions(['authenticateOidcSilent', 'removeOidcUser']),
      reauthenticate() {
